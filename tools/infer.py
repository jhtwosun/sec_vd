...
import sys
sys.path.append('/home/dongjae.lee/ftp_shared_internal/Projects/SEC_VD/1.Code/PatchFusion/')
...
def main():
    ...
    model.depth_model.load_state_dict(torch.load('/home/dongjae.lee/ftp_shared_internal/Projects/SEC_VD/1.Code/PatchFusion/pretrained_ckpt/depth_anything_v2_vits.pth'))
    ...
    margin_width = 50
    video_path = '/home/dongjae.lee/ftp_shared_internal/Projects/SEC_VD/2.Dataset/mid_DB'
