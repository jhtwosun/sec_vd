_base_ = [
    '../_base_/datasets/mvs.py', 
]

min_depth=1e-3
max_depth=80
patch_process_shape=(2128, 3808)

amp = None #tf32 bf16 fp16 None

core_config=dict(  
    encoder_type='vitl_prompt',
    pretrained_resource='/home/gyojin.han/ftp_shared_internal/Projects/SEC_VD/1.Code/PatchFusion/pretrained_ckpt/depth_anything_v2_vitl.pth',
