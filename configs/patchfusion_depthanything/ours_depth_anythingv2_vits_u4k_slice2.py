...
train_cfg=dict(max_epochs=50, val_interval=2, save_checkpoint_interval=10, log_interval=100, train_log_img_interval=400, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
...
train_dataloader=dict(
    dataset=dict(
        ...
        patch_raw_shape=patch_process_shape)) # random crop size
